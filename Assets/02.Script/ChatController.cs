...
//        client.Connect("34.64.70.123", 7777); // 서버 주소 및 포트 번호
...
//        PrintChatData(currentInputType, currentTextColor, $"{ID} : {inputField.text}");
//        inputField.text = "";
...
////    private void Start()
////    {
////        ws = new WebSocket("ws://localhost:8080");  // WebSocket 서버 주소로 초기화
////        ws.OnMessage += (sender, e) =>
////        {
////            // 서버에서 수신한 메시지를 표시하는 부분
////            PrintChatData(ChatType.Normal, Color.white, e.Data);
////        };
////        ws.Connect();
////    }
